...
//                                $max_total_sales = $total_sales[$date];
     ...
     */
    function banking_overview_search() {
        global $WCMp, $wpdb;
        ...
        $table = '';
            $table .= "<table class='widefat'>
                <thead>
                    <tr>
                        <th>" .esc_html( 'Status', 'woocommerce' ). "</th>
                        <th class='total_row'>" .esc_html( 'Date', 'woocommerce' ). "</th>
                        <th class='total_row'>" .esc_html( 'Type', 'woocommerce' ). "</th>
                        <th class='total_row'>" .esc_html( ' Reference', 'woocommerce' ). "</th>
                        <th class='total_row'>" .esc_html( ' Credit', 'woocommerce' ). "</th>
                        <th class='total_row'>" .esc_html( 'Debit', 'woocommerce' ). "</th>
                        <th class='total_row'>" .esc_html( 'balance', 'woocommerce' ). "</th>
                    </tr>
                </thead>
                <tbody>";
